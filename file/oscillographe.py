...
"""Le but est de fournir un instrument de visualisation simple d'un système
d'affichage automatique de graphiques élongation/temps"""
...
#         "Constructeur du graphique : axes et échelles horiz."
...
#             e = ampl*sin(2*pi*freq*t/100 - phase)
#             x = 10 + t*pas
...
#     root.mainloop()
# ====================================================================
""" Widget dérivé de <Canvas>, spécialisé pour dessiner des graphiques élongation/temps"""
# ====================================================================
