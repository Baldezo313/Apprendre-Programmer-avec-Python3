...
# Module donnant accès aux boîtes de dialogues standard pour la
# recherche de fichiers sur disques :
from tkinter.filedialog import asksaveasfile, askopenfile

# ==============================================================
"""DICTIONNAIRES DE COULEURS"""
"""Réaliser un petit programme utilitaire, qui puisse nous aider à construire
 facilement et rapidement un nouveau dictionnaire de couleurs, lequel permettrait
 l'accès technique à une couleur quelconque par l'intermédiaire de son nom usuel en français"""
