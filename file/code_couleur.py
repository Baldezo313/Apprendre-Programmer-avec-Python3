...
# CODE DES COULEURS:
"""Un application qui permet de retrouver rapidement le code de trois couleur
qui correspond à une résistance électrique de valeur bien déterminée.
Notre application doit faire apparaître une fénêtre comportant un dessin de la
résistance, ainsi qu'un champ d'entrée dans lequel l'utilisateur peut encoder
...
class Application(object):
    ...
    def changeCouleurs(self):
        ...
        if err == 1 or 1e11 < v < 10:
            ...
            # nbr de zéros à accoler aux 2 chiffres significatifs :
            li[2] = logv - 1
